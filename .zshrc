...
# --- Azure VPN cert fix (skill: azure-vpn-cert-fix), added 2026-06-19 ---
alias vpncheck='/home/austin/.agents/skills/azure-vpn-cert-fix/scripts/diagnose.sh'    # read-only: which pinned roots are missing
alias vpnfix='/home/austin/.agents/skills/azure-vpn-cert-fix/scripts/restore-roots.sh' # restore missing pinned roots (asks sudo)

# --- fzf keybindings + completion (Alt+C cd, Ctrl+T files, Ctrl+R history) ---
